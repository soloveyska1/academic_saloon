...
* ВАЖНО: Установка десятичного разделителя (точка).
SET DECIMAL=DOT.
SET MXWARNS=100.
...
VARIABLE LABELS
  ...
  BSS 'Благопр сем ситуация'
  Anxiety 'Тревожность'
  Conflict 'Конфликтность'
  Inferiority 'Чувство неполноценности'
  Hostility 'Враждебность'
  LichPlus 'Личностные выборы плюс'
  LichMinus 'Личностные выборы минус'
  PoznPlus 'Познават выборы плюс'
  PoznMinus 'Познават выборы минус'
  LichStatus 'Личностный статус'
  PoznStatus 'Познават статус'
  TotalStatus 'Общий статус'
  EmoLica 'Эмоц лица из 17'.
...
* ============================================================================.
* БЛОК 7: ПРОЦЕНТ ОПОЗНАНИЙ.
* ============================================================================.

COMPUTE EmoLica_Pct = EmoLica / 17 * 100.
VARIABLE LABELS EmoLica_Pct 'Процент опознаний'.
EXECUTE.
...
* ============================================================================.
* КОНЕЦ. Выделить все и нажать Ctrl+R.
* ============================================================================.
