...
const GUARANTEES: Guarantee[] = [
  ...
  },
  {
    ...
    hook: 'До 3 циклов в пределах исходного ТЗ',
...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Объективные недостатки устраняются без доплаты. Дополнительно в пределах исходного ТЗ доступны до трёх циклов согласовательных правок; новые требования оформляются отдельно.',
  },
]
