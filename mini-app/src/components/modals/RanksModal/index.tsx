...
const RANK_FLAVOR: Record<string, { tagline: string; perks: string[] }> = {
  resident: {
    ...
    perks: ['Кешбэк 3% на все заказы', 'Доступ к программе лояльности', 'Бесплатные правки'],
  },
  partner: {
    tagline: 'Вас уже знают по имени',
    perks: ['Кешбэк 5% на все заказы', 'Приоритет при распределении авторов', 'Расширенные правки'],
  },
  vip: {
    tagline: 'Привилегии, которые чувствуются',
    perks: ['Кешбэк 7% на все заказы', 'Высокий приоритет поддержки', 'Персональный менеджер'],
  },
  premium: {
    tagline: 'Максимум. Во всём',
    perks: ['Кешбэк 10% на все заказы', 'VIP-поддержка 24/7', 'Индивидуальные условия'],
  },
}
        ...
        {nextRank && (
          ...
          >
            ...
            <div style={{
              ...
              {progress}% пройдено — кешбэк вырастет до {nextRank.cashback}%
            </div>
          </m.div>
        )}
        ...
        {user.rank.is_max && (
          ...
          >
            ...
            <div style={{
              ...
              Максимальный кешбэк 10% активен. Все привилегии разблокированы
            </div>
          </m.div>
        )}
