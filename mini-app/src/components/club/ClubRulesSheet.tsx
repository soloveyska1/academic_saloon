...
const rules = [
  ...
  },
  {
    ...
    text: 'Уровень повышается за баллы прогресса. Они начисляются за активность в разделе бонусов и оплаченные заказы. Чем выше уровень, тем больше преимуществ.',
  },
  {
