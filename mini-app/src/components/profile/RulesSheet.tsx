...
export const RulesSheet = memo(function RulesSheet({
  ...
  const rules = [
    ...
    },
    {
      ...
      description: 'Повышайте уровень, набирая баллы прогресса за заказы и активность. Каждый уровень даёт новые привилегии и скидки.',
    },
    {
              ...
              >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  {[
                    ...
                    'Уровень повышается автоматически при достижении порога баллов прогресса',
                    'Баллы привилегий не сгорают, пока вы активны',
                  ].map((point, idx) => (
