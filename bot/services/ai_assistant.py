...
FAQ_DATABASE: list[FaqEntry] = [
    ...
    FaqEntry(
        ...
        answer=(
            "В каждый заказ включены безлимитные правки в рамках исходного ТЗ.\n"
            "Правки принимаются в течение 14 дней после сдачи.\n\n"
            "Если меняются тема, объём, структура или само задание, менеджер согласует это отдельно."
        ),
    ...
    FaqEntry(
        ...
        answer=(
            ...
            "• Прямое сообщение @academicsaloon\n\n"
