...
# Короткие приветствия для "диалога"
GREETING_MORNING = "Доброе утро, {name}. ☀️"
GREETING_DAY = "Добрый день, {name}. 🌵"
GREETING_EVENING = "Добрый вечер, {name}. 🌅"
GREETING_NIGHT = "Доброй ночи, {name}. 🌙"

# Основной текст (компактный, с ценностью)
MAIN_USP = """Здесь всё по-честному: даёшь задачу — я беру пыльную работу на себя.
Тихо, быстро и в срок.

🤠 <b>6 лет</b> в деле • <b>3 правки</b> бесплатно • от <b>900₽</b>
{stats_line}
{discount_line}
Жми кнопку — садись за стойку 👇"""
...
<i>Нажми play — расскажу, как тут всё устроено</i>"""
