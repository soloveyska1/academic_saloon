...
4. Платите по мере готовности — за то, что уже сделано.

<i>Дальше — про оплату.</i>""",
    2: """<b>Оплата</b>

Никакой предоплаты целиком. Работа делится на этапы:
• 30 / 40 / 30 — для больших работ
• 50 / 50 — для небольших

Реквизиты приходят прямо в боте, когда этап готов к оплате.
После каждой оплаты — чек самозанятого.

<i>Дальше — про бонусы.</i>""",
    3: """<b>Бонусы</b>

• Новичкам — 300 бонусов в подарок (действуют 30 дней!)
