...
def build_price_list_caption() -> str:
    """Формирует caption для прайс-листа по предложению Gemini"""
    lines = [
        "📜 <b>ТАРИФЫ И ГАРАНТИИ САЛУНА</b>",
        "",
        "Мы работаем чисто и на совесть.",
        "",
        "🔒 <b>Цифровая гигиена:</b> Мы НЕ загружаем работу в вузовские системы (Антиплагиат.ВУЗ). Твой файл остаётся «чистым» до твоей сдачи.",
        "",
        "🔄 <b>3 Круга правок:</b> В цену уже включены 3 полноценные итерации доработок по замечаниям научрука.",
        "",
        "📝 <b>Оформление:</b> Сразу делаем по ГОСТ или твоей методичке.",
        "",
        "━━━━━━━━━━━━━━━━━━━━",
        "",
        "🎓 <b>Высшая Лига</b>",
        ...
        "<i>Пишем главами. Оплата частями 50/50</i>",
        "",
        ...
        "━━━━━━━━━━━━━━━━━━━━",
        "",
        "⚠️ Цены за <b>стандартный срок</b>.",
        "Нужно «вчера»? Экспресс +30...100%",
    ]
    return "\n".join(lines)
